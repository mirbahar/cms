...
<head>
    ...
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/normalize.css" type="text/css" media="all">
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/fonts/font-awesome/css/font-awesome.min.css" type="text/css" media="all">
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/bootstrap.min.css" type="text/css" media="all">
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/owl.carousel.css" type="text/css" media="all">
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/owl.theme.css" type="text/css" media="all">
    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/owl.transitions.css" type="text/css" media="all">
    ...
    <link href="<?php echo base_url() ;?>assets/FrontEnd/css/metro-icons.css" rel="stylesheet">
    <!-- <link href="css/metro-bootstrap.css" rel="stylesheet"> -->
    <link href="<?php echo base_url() ;?>assets/FrontEnd/css/metro.css" rel="stylesheet">


    <link rel="stylesheet"  href="<?php echo base_url() ;?>assets/FrontEnd/css/style.css" type="text/css" media="all">
    <script src="<?php echo base_url() ;?>assets/FrontEnd/js/jquery(1).js"></script>
    <script src="<?php echo base_url() ;?>assets/FrontEnd/js/main.js"></script>
    <script src="<?php echo base_url() ;?>assets/FrontEnd/js/metro.js"></script>
</head>
                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            <li class=""><a href="<?php echo site_url(); ?>"><?php echo lang('safe_camp')?></a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php } else {?>
                                    <li><a id="modal_trigger" href="#modal" style="width: 139px;" class="btn login"><?php echo lang('login')?></a></li>
                                    <?php } ?>
                                    <li><a id="" href="<?php echo site_url()?>auth/sign_up" class="btn"><?php echo lang('create_new_user')?></a></li>
        ...
        <div class="social_login">
            <div class="user_login">
                ...
                <form action="<?php echo site_url(); ?>auth/frontEndLogin" method="post">
                    ...
                    <input type="text"name="identity" style="padding-left:25px;">
                    <br>

                    <label><?php echo lang('password')?></label>
                    <span class="mif-lock"></span>
                    <input type="password" name="password" style="padding-left:28px;">
                    <br>
                    ...
                    <div class="action_btns">
                        ...
                        <div class="one_half last modal_close">
                            <input type="submit" class="btn btn_red " value="<?php echo lang('cancel')?>">
                            <a href="#" ><?php echo lang('cancel')?></a></div>
                    </div>
                </form>
